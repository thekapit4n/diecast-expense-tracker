...
-- ========================================
CREATE TABLE public.tbl_collection_detail (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
DROP TABLE IF EXISTS public.tbl_purchase;
DROP TABLE IF EXISTS public.tbl_collection_detail;
DROP TABLE IF EXISTS public.tbl_collection;
